      ...
      <div class="container-fluid">
        ...
        <div class="card-body">
          ...
          <div class="row mt-4">
            <nav class="w-100">
              <div class="nav nav-tabs" id="product-tab" role="tablist">
                <a class="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">Deskripsi Buku</a>
              </div>
            </nav>
            <div class="tab-content p-3" id="nav-tabContent">
              <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"> <?php if($buku['deskripsi'] == null){
          ...
          <div class="card mt-3" style="width:500px;">
            ...
            <div class="mt-4">
               <a class="btn btn-danger btn-flat float-right" href="katalogbuku.php">Kembali</a>
            </div>
        </div>
        <!-- /.card-body -->
      </div>
